...
@ObjectModel.sapObjectNodeType.name: 'ZRAP110_Booking_004'
define view entity ZRAP110_R_BOOKINGTP_004
  as select from ZRAP110_ABOOK004 as Booking
  association to parent ZRAP110_R_TRAVELTP_004 as _Travel on $projection.TravelID = _Travel.TravelID
